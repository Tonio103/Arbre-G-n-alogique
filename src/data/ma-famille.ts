...
export const MA_FAMILLE: FamilyDataset | null = {
  ...
  people: [
    { id: 'francois-albertini', firstName: 'François', lastName: 'Albertini', gender: 'm', spouses: ['yannick-rivoual'] },
    { id: 'yannick-rivoual', firstName: 'Yannick', lastName: 'Rivoual', gender: 'f' },
    { id: 'francoisse-maillet', firstName: 'Françoisse', lastName: 'Maillet', gender: 'f', spouses: ['francois-maillet'] },
    { id: 'francois-maillet', firstName: 'François', lastName: 'Maillet', gender: 'm' },
    {
      id: 'manuel-albertini',
      firstName: 'Manuel',
      lastName: 'Albertini',
      gender: 'm',
      birthDate: '1975',
      parents: ['francois-albertini', 'yannick-rivoual'],
      spouses: ['marie-ange-maillet'],
    },
    {
      id: 'marie-ange-maillet',
      firstName: 'Marie-Ange',
      lastName: 'Maillet',
      gender: 'f',
      birthDate: '1975',
      parents: ['francoisse-maillet', 'francois-maillet'],
    },
    {
      ...
      gender: 'm',
      birthDate: '2010',
      parents: ['manuel-albertini', 'marie-ange-maillet'],
    },
    {
      id: 'stella-albertini',
      firstName: 'Stella',
